...
public class fly_weight_pattern {
...
//                TreeFlyWeight TreeFlyweight = new TreeFlyWeight(s, cl);
                tree t1 = new tree(TreeFlyweight);
                t1.plantTree(x++,y++);
//        TreeFlyWeight neemTreeFlyweight = treeFactory.createTree("neem_tree", "green");
            }
...
//        System.out.println("maximum density of tree: " + TreeFactory.count_neem + TreeFactory.count_oak);
